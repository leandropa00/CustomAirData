...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    ...
    <title id="titulo_pagina">@yield('page_title', 'CustomAirData')</title>
    ...
    <link rel="stylesheet" type="text/css" href="{{url('/')}}/includes/app-assets/vendors/css/charts/apexcharts.css">
    <link rel="stylesheet" type="text/css" href="{{url('/')}}/includes/app-assets/vendors/css/extensions/tether-theme-arrows.css">
    <link rel="stylesheet" type="text/css" href="{{url('/')}}/includes/app-assets/vendors/css/extensions/tether.min.css">
    <link rel="stylesheet" type="text/css" href="{{url('/')}}/includes/app-assets/vendors/css/extensions/shepherd-theme-default.css">
    <!-- END: Vendor CSS-->
    ...
    <link rel="stylesheet" type="text/css" href="{{url('/')}}/includes/app-assets/css/pages/dashboard-analytics.css">
    <link rel="stylesheet" type="text/css" href="{{url('/')}}/includes/app-assets/css/pages/card-analytics.css">
    <link rel="stylesheet" type="text/css" href="{{url('/')}}/includes/app-assets/css/plugins/tour/tour.css">
    <!-- END: Page CSS-->
