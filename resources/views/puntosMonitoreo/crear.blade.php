        ...
        <div class="content-wrapper">
            ...
            <div class="content-body">
                <section id="basic-vertical-layouts">
                    ...
                    <form class="form form-vertical" action="{{ route('puntos-monitoreo.store', $campana->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf        
                        <div id="accordionWrapa1" role="tablist" aria-multiselectable="true">
                            <div class="card collapse-icon accordion-icon-rotate">
                                <div class="card-header">
                                    <h4 class="card-title">Crear un punto de monitoreo para {{$campana->nombre}}</h4>
                                </div>
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div>
                                                                                <select name="estacion_id" id="estacion_id" class="form-control select2" data-style="form-control" required>
                                                                                    ...
                                                                                    <option value="{{ $estacion->id }}">{{ ucwords($estacion->nombre) }}</option>
                                                                                    @endforeach
                                                                                </select>
                                                                            </div>
                                                                        </div>
                                                                    ...
                                                                    <div class="form-group col-md-2 col-6">
                                                                        <fieldset class="checkbox">
                                                                            <div class="vs-checkbox-con vs-checkbox-primary">
                                                                                <input class="checkbox_contaminantes" type="checkbox" name="contaminantes[]" value="{{$item->id}}">
