                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Listado de puntos de monitoreo de {{$campana->nombre}}</h4>
                                @if (Auth::user()->rol=='admin')
                                    <div class="modal-size-lg mr-1 mb-1 d-inline-block">
                                        <a href="{{ route('puntos-monitoreo.create', $campana->id) }}" class="btn btn-outline-warning">Crear un nuevo punto de monitoreo</a>
                                    </div>
                                @endif
                            </div>
                            ...
                            <div class="card-content">
                                <div class="card-body card-dashboard">
                                    ...
                                    <table class="table table-striped dataex-html5-selectors">
                                            ...
                                            <tbody>
                                                @forelse ($puntos_monitoreo as $item)
                                                  <tr>
