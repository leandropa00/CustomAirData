                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6 col-12">
                                                        <div class="form-group">
                                                            <label>Latitud</label>
                                                            <div class="position-relative has-icon-left">
                                                                <input type="number" step="any" id="latitude" class="form-control" name="latitude" placeholder="Ingresa la latitud de la estación" required>
                                                                <div class="form-control-position">
                                                    ...
                                                    <div class="col-md-6 col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="position-relative has-icon-left">
                                                                <input type="number" step="any" id="longitude" class="form-control" name="longitude" placeholder="Ingresa la longitud de la estación" required>
                                                                <div class="form-control-position">
                                                                    <i class="feather icon-map-pin"></i>
                                                                </div>
                                                            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/logjanec/public_html/customair/resources/views/add_location.blade.php ENDPATH**/ ?>