<div class="row" style="background-color: #f8f8f8;">
    <div class="col-12 col-md-12">
        <h3 class="h_heading">&nbsp;&nbsp;<?php echo e(strtoupper($campana->nombre)); ?> - Último dato: <?php echo e(carbon\Carbon::parse($ultimoDato->fecha_hora)->format('d/m/Y g:i A')); ?></h3>
    </div>   
...
?><?php /**PATH C:\Program Files\Ampps\www\CustomAirData\resources\views/mapa/description_map.blade.php ENDPATH**/ ?>