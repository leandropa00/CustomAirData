                                                ...
                                                <div class="row">
                                                    <div class="col-12 col-md-6">
                                                        <div class="form-group">
                                                            <label>Nombre</label>
                                                            <div class="position-relative has-icon-left">
                                                                <input minlength="3" maxlength="40" type="text" class="form-control" name="nombre_manager" autocomplete="nombre_manager" required placeholder="Ingresa un nombre para el usuario" >
                                                    ...
                                                    <div class="col-12 col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="position-relative has-icon-left">
                                                                <input maxlength="30" type="email" class="form-control" name="correo" placeholder="Ingresa el correo electrónico" required autocomplete="email">
                                                    ...
                                                    <div class="col-12 col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="position-relative has-icon-left">
                                                                <input id="password" type="password" minlength="8" maxlength="20" class="form-control" name="contrasena" placeholder="Ingresa una contraseña" required autocomplete="new-password">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/AMPPS/www/customair/resources/views/empresas/crear.blade.php ENDPATH**/ ?>