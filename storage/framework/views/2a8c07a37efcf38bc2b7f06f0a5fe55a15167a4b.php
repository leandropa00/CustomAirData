...
<script>
    ...
    var markers = [
        ...
        <?php $__empty_1 = true; $__currentLoopData = $estaciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        {
            "title": '<?php echo e(ucfirst($item->location_name) . " - " . ucfirst($item->client)); ?>',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/logjanec/public_html/customair/resources/views/mapDashboard/index.blade.php ENDPATH**/ ?>