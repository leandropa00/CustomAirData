                                                ...
                                                <div class="row">
                                                    <div class="col-md-6 col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="position-relative has-icon-left">
                                                                <input type="text" maxlength="30" class="form-control" value="<?php echo e($campana->nombre); ?>" name="nombre" minlength="3" placeholder="Ingrese un nombre para la campaña" required>
                                                    ...
                                                    <div class="col-md-6 col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="position-relative has-icon-left">
                                                                <textarea  id="notes" maxlength="100" class="form-control" name="observaciones" placeholder="Ingresa información adicional (opcional)"><?php echo e($campana->observaciones); ?></textarea>
                                                                <div class="form-control-position">
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/logjanec/public_html/customair/resources/views/campanas/editar.blade.php ENDPATH**/ ?>