<div class="row" style="background-color: #f8f8f8;">
    <div class="col-12 col-md-4">
        <h3 class="h_heading">&nbsp;&nbsp;<?php echo e(strtoupper($location->location_name)); ?> <?php echo e(carbon\Carbon::parse($ultimoDato->datetime)->format('d/m/Y g:i A')); ?></h3>   
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $contaminantes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr style="background-color:
                        ...
                        ?>
                    " onclick="get_chart(<?php echo e($location->id); ?>,'<?php echo e($item->nombre_campo); ?>', '<?php echo e($item->conversion); ?>');" data-toggle="tooltip" title="Ver <?php echo e($item->nombre); ?>">
                        <td width="30%"> 
...
?><?php /**PATH /home/logjanec/public_html/customair/resources/views/mapDashboard/description_map.blade.php ENDPATH**/ ?>