                            ...
                            <div class="card-content">
                                <div class="card-body card-dashboard">
                                    ...
                                    <table class="table table-striped dataex-html5-selectors">
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $puntos_monitoreo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                  <tr>
    ...
    function abrirModal(id){
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $("#modalDetallesLabel").html(response[0]);                
                // $("#modalDetallesLabel").html(response.titulo);                
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Program Files\Ampps\www\CustomAirData\resources\views/puntosMonitoreo/index.blade.php ENDPATH**/ ?>