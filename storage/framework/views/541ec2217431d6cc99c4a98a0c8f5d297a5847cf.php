...
unset($__errorArgs, $__bag); ?>
                                        <div class="form-group"> 
                                            ...
                                            <input placeholder="Ingresa tu correo" id="email" type="email" class="form-control <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>" name="password" required autocomplete="current-password">
    ...
    <script>
        ...
        $('#sendForm').click(function (e) { 
            ...
            $.ajax({
                type: "get",
                url: "<?php echo e(route('recuperarContrasena')); ?>",
        ...
        function validarCódigo() {
            ...
            if($('#codigoIngresado').val() == codigo){
                $('#modal-body').empty();
                $('#modal-body').html(
                    `<form action="<?php echo e(route('cambiarContrasena')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
</html><?php /**PATH /home/logjanec/public_html/customair/resources/views/auth/login.blade.php ENDPATH**/ ?>