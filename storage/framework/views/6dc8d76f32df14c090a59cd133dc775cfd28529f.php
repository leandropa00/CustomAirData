                                                ...
                                                <div class="col-12 col-md-2">
                                                    <select class="form-control" name="location" required>
                                                        ...
                                                        <?php $__currentLoopData = $locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($item->id); ?>" <?php if($item->id == $location_id): ?> selected <?php endif; ?>><?php echo e(ucfirst($item->location_name)); ?></option>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/logjanec/public_html/customair/resources/views/dashboard.blade.php ENDPATH**/ ?>