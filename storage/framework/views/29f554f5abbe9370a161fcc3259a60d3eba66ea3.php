                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div>
                                                                                <input maxlength="100" id="ruta" class="form-control" name="ruta" placeholder="Ruta" required>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div>
                                                                                <input type="text" id="depto_name" class="form-control" name="depto_name" minlength="3" maxlength="20" placeholder="Ingrese nombre del departamento">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div>
                                                                                <input type="text" id="muni_name" class="form-control" name="muni_name" minlength="3" maxlength="20" placeholder="Ingrese nombre del municipio">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label for="password-icon">Coordenadas*</label>
                                                                            <div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Program Files\Ampps\www\CustomAirData\resources\views/puntosMonitoreo/crear.blade.php ENDPATH**/ ?>