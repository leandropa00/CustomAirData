                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="modal-size-lg mr-1 mb-1 d-inline-block">
                                    <a href="<?php echo e(route('add-location')); ?>" class="btn btn-outline-warning">Crear una nueva estación</a>
                                </div>
                            </div>
                                ...
                                <div class="card-body card-dashboard">
                                    <div class="table-responsive">
                                        <table class="table table-striped dataex-html5-selectors">
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $location_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr>
                                                        <td><?php echo e(ucwords($data->location_name)); ?></td>
                                                        <td><?php echo e($data->server_path); ?></td>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-icon btn-outline-warning waves-effect waves-light" href="<?php echo e(route('location-edit', ['id' => $data->id])); ?>"><i class="feather icon-edit"></i></a>
                                                            <a class="btn btn-icon btn-outline-danger waves-effect waves-light" href="<?php echo e(route('location-delete', ['id' => $data->id])); ?>"><i class="feather icon-trash-2"></i></a>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </tbody>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/logjanec/public_html/customair/resources/views/location.blade.php ENDPATH**/ ?>