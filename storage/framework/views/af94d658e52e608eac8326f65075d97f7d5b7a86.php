...
<script>
    ...
    var markers = [
        ...
        <?php $__empty_1 = true; $__currentLoopData = $location_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        {
            "title": '<?php echo e(ucfirst($data->location_name) . " - " . ucfirst($data->client)); ?>',
            "lat": '<?php echo e($data->latitude); ?>',
            "lng": '<?php echo e($data->longitude); ?>',
            "description": html(<?php echo e($data->id); ?>)
        },
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/logjanec/public_html/customair/resources/views/estatus.blade.php ENDPATH**/ ?>