                    ...
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="modal-size-lg mr-1 mb-1 d-inline-block">
                                    <a href="<?php echo e(route('add-user')); ?>" class="btn btn-outline-warning">Crear un nuevo usuario</a>
                                </div>
                            </div>
                                            ...
                                            <tbody>
                                                <?php $__currentLoopData = $users_data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                  <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-icon btn-outline-warning waves-effect waves-light" href="<?php echo e(route('user-edit', ['id' => $data->id])); ?>"><i class="feather icon-edit"></i></a>
                                                        <a class="btn btn-icon btn-outline-danger waves-effect waves-light" href="<?php echo e(route('user-delete', ['id' => $data->id])); ?>"><i class="feather icon-trash-2"></i></a>
                                                    </td>
                                                </tr>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </tbody>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/logjanec/public_html/customair/resources/views/users.blade.php ENDPATH**/ ?>