                                                    ...
                                                    <div class="col-12 col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="position-relative has-icon-left">
                                                                <input id="name" minlength="3" type="text" class="form-control" name="name" autocomplete="name" required placeholder="Ingresa un nombre para el cliente" >
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/logjanec/public_html/customair/resources/views/add_user.blade.php ENDPATH**/ ?>